...
static int add_sp(sdp_session_t *session, svc_info_t *si)
{
	...
	uuid_t root_uuid, sp_uuid, l2cap, rfcomm ,svclass_uuid;
	...
	sdp_set_service_classes(&record, svclass_id);
        ...
        sdp_uuid128_create(&svclass_uuid, (void *) iap_uuid);
...
static unsigned char sr1_uuid[] = {
                                        0xec ,0x88, 0x43, 0x48, 0xcd,  0x41, 0x40, 0xa2,
...
static int add_sr1(sdp_session_t *session, svc_info_t *si)
{
	...
	sdp_set_info_attr(&record, "CarPlay", NULL, NULL);
...
static int add_iap(sdp_session_t *session, svc_info_t *si)
{
        sdp_record_t record;
        sdp_list_t *root, *svclass;
        uuid_t root_uuid, svclass_uuid;
        ...
        sdp_set_info_attr(&record, "iap2", NULL, NULL);
        ...
        printf("iap2 service record registered\n");
